...
// export class LanguageServicePrototyp {
// 	public static currentLanguageService: LanguageService | undefined;
// 	private readonly _extensionUri: vscode.Uri;
// 	private languageFileInfo: ILanguageFileInfo[] = [];
// 	private xlfFilePaths: string[] = [];
// 	private data: Array<IData>;

// 	public static getInstance(extensionUri: vscode.Uri): LanguageService{
// 		if (! this.currentLanguageService){
// 			this.currentLanguageService = new LanguageService(extensionUri);
// 		}
...
// 	public async getDataGrid(languageCode: string): Promise<any> {
// 		if (await this.isDirty){
// 			await this.calcDataGrid();
// 		}
...
// 			return !targetLanguageInfos.IsMain && targetLanguageInfos.LanguageCode === languageCode;
...
// 	public async getDiagnostics(): Promise<Array<IDiagnostic>> {
...
// 			this.collectXlfFiles(this._extensionUri)
// 				.then((xlfFilePaths) => {
// 					this.xlfFilePaths = xlfFilePaths;
...
// 	private getHash(jsonObj: any): number {
...
// 	private async getDiagnosticAsync(data: IData): Promise<Array<IDiagnostic>> {
// 		const diagnostics: Array<IDiagnostic> = [];
...
//     private collectXlfFiles(extensionUri: vscode.Uri): Promise < string[] > {
// 			const promise = new Promise<string[]>((resolve, reject) => {
// 				walk(extensionUri.fsPath,
