...
export class TranslatableElementsView {
...
function refreshElements(): vscode.TreeDataProvider<{ key: string }> {
		return {
...
function getTreeItem(key: string): vscode.TreeItem {
	...
	const tooltipMarkDown = new vscode.MarkdownString(`$(zap) Tooltip for ${key}`, true);
	const tooltip = tooltipMarkDown.value
	return {
